...
All NetworkX-related operations for hypothesis graphs: building, validation,
subgraph extraction, statistics, and the class-based builder API.
...
from app.schemas import Edge, EdgeType, GraphEdge, Hypothesis
